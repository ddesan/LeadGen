...
const findManyPaginated = typeName => async rp => {
  ...
  const args = Object.assign({}, rp.args, {
    group: group || [],
    distinct: distinct || []
  });
  const result = await findMany(typeName)(Object.assign({}, rp, {
    args
  }));
...
const link = ({
  ...
  const fieldValue = await originalResolver(source, args, context, Object.assign({}, info, {
